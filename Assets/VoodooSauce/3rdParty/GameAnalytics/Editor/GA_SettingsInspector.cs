...
namespace GameAnalyticsSDK.Editor
{
    ...
    public class GA_SettingsInspector : UnityEditor.Editor
    {
        ...
        private const string _gaGizmosPath = "Assets/VoodooSauce/3rdParty/GameAnalytics/Gizmos/";
        ...
        void OnEnable()
        {
            ...
            {
                ga.UpdateIcon = (Texture2D)AssetDatabase.LoadAssetAtPath(_gaGizmosPath + "Images/update_orange.png", typeof(Texture2D));
            }

            if(ga.DeleteIcon == null)
            {
                ga.DeleteIcon = (Texture2D)AssetDatabase.LoadAssetAtPath(_gaGizmosPath + "Images/delete.png", typeof(Texture2D));
            }

            if(ga.GameIcon == null)
            {
                ga.GameIcon = (Texture2D)AssetDatabase.LoadAssetAtPath(_gaGizmosPath + "Images/game.png", typeof(Texture2D));
            }

            if(ga.HomeIcon == null)
            {
                ga.HomeIcon = (Texture2D)AssetDatabase.LoadAssetAtPath(_gaGizmosPath + "Images/home.png", typeof(Texture2D));
            }

            if(ga.InfoIcon == null)
            {
                ga.InfoIcon = (Texture2D)AssetDatabase.LoadAssetAtPath(_gaGizmosPath + "Images/info.png", typeof(Texture2D));
            }

            if(ga.InstrumentIcon == null)
            {
                ga.InstrumentIcon = (Texture2D)AssetDatabase.LoadAssetAtPath(_gaGizmosPath + "Images/instrument.png", typeof(Texture2D));
            }

            if(ga.QuestionIcon == null)
            {
                ga.QuestionIcon = (Texture2D)AssetDatabase.LoadAssetAtPath(_gaGizmosPath + "Images/question.png", typeof(Texture2D));
            }

            if(ga.UserIcon == null)
            {
                ga.UserIcon = (Texture2D)AssetDatabase.LoadAssetAtPath(_gaGizmosPath + "Images/user.png", typeof(Texture2D));
            }
            ...
            if(ga.Logo == null)
            {
                ga.Logo = (Texture2D)AssetDatabase.LoadAssetAtPath(_gaGizmosPath + "gaLogo.png", typeof(Texture2D));
            }
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            if(ga.SignupButton == null)
            {
                ...
                signupButton.normal.background = (Texture2D)AssetDatabase.LoadAssetAtPath(_gaGizmosPath + "Images/default.png", typeof(Texture2D));
                signupButton.active.background = (Texture2D)AssetDatabase.LoadAssetAtPath(_gaGizmosPath + "Images/active.png", typeof(Texture2D));
